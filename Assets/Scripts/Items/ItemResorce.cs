...
public class ItemResorce : MonoBehaviour {
    ...
    private void Start() {
        ...
        resource_data.Add(Enums.enum_item.pickup.ToString(), new ItemResorceData("Material\\Pickup", "Spawn Modules and Blue Prints or Material", Enums.enum_item.pickup, Enums.enum_resorce_type.asset));
    ...
    public ItemResorceData Spawn_Any_Module_Upgrade_Material() {
        ...
        } while (item.resorce_type == enum_resorce_type.asset|| item.item_type == enum_item.module_command_module_type1);
